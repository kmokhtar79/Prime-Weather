...
// Optionally show user's name.
const user = ""

// You can exchange the  high tmeprature text as your liking 
...
let API_WEATHER = "xxxxxxxxxxxxxxxxx";//Load Your api here
let CITY_WEATHER = "xxxxxxxxxxxxxxxxx";//add your city ID
