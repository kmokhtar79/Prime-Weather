...
temptext.font = Font.semiboldMonospacedSystemFont(22);
//condition label in stack
let currenttext = hStack.addText(" "+ weathername+ " today" + " with a top of " + Math.round(highTemp)+"\u00B0");
currenttext.textColor = fontColor;
currenttext.textOpacity = (0.8);
